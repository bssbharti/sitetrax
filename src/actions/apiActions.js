...
export function saveHoistCamDirectorImages1(images) {
  console.log("saveHoistCamDirectorImages1 called");
  return {
    type: types.SAVE_UPLOADED_IMAGES,
    images,
  };
}

export function saveHoistCamDirectorImages(images) {
  return (dispatch) => {
    console.log('inside saveHoistCamDirectorImages');
    //dispatch(saveHoistCamDirectorImages1(images));
  };
}
